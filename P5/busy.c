/*Sesion 5: Signal*/
/*Ej5a: Medicion de los us que le pasemos como parametro usando espera "usleep" */
...
/*Observacion: usleep no se espera durante unos us exactos sino que va variando*/