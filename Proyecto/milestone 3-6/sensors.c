...
int init_sensors()
{
  connect_pipe("speedpipe", &speed_fd_read, &speed_fd_write);
  connect_socket(20010, &alt1_fd);
  connect_socket(20011, &alt2_fd);
  connect_socket(20012, &alt3_fd);
  connect_socket(20015, &leftsensor_fd);
  connect_socket(20016, &rightsensor_fd);
  return 0;
}
